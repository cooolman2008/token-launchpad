...
import { useWalletClient, useAccount, useContractWrite } from "wagmi";
                ...
                <div className="w-full">
                  ...
                  <div className="flex mb-12 mt-4">
                    <div className="flex flex-col">
                      ...
                      <button className="px-4 py-1 select-none rounded-3xl text-white bg-blue-500 hover:bg-blue-600 me-2 mb-2 cursor-pointer text-lg font-medium">
                        Claim $62.02M
                      </button>
                    </div>
                  </div>
                    ...
                    <div className="w-full p-4 rounded-xl border-2 border-transparent hover:border-neutral-800 bg-neutral-900 mb-2">
                      ...
                      <div className="w-full flex">
                        <input
                          ...
                          className="block w-full rounded-xl ps-3 pe-3 py-1.5 text-white shadow-sm placeholder:text-gray-400 sm:leading-6 bg-neutral-900 outline-0 sm:text-4xl border-x border-gray-400"
                        />
                  ...
                  <div className="w-full p-4 rounded-xl border-2 border-transparent hover:border-neutral-800 bg-neutral-900 mb-2">
                    ...
                    <div className="w-full flex">
                      <input
                        ...
                        className="block w-full rounded-xl ps-3 pe-3 py-1.5 text-white shadow-sm placeholder:text-gray-400 sm:leading-6 bg-neutral-900 outline-0 sm:text-2xl"
                      />
                      <span className="block sm:text-4xl leading-6 text-gray-400 pt-1.5">
                        <svg
                          width="40px"
