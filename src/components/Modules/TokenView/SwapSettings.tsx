...
const SwapSettings = ({ register, errors }: { register: UseFormRegister<SwapForm>; errors: FieldErrors<SwapForm> }) => {
	...
	return (
		<div className="relative">
			...
			{isOpen && (
				<div
					ref={wrapperRef}
					className="absolute top-10 right-0 rounded-xl bg-neutral-900 p-4 border-2 border-neutral-800 w-80 z-10 flex"
				>
					<div className="mr-8">
