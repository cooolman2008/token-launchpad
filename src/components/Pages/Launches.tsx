		...
		<>
			{isClient && (
				<>
					...
					<div className="flex self-start my-4 min-w-full px-3 flex-wrap">
						<h2
							className={heading_classes + (tab === "Explore" ? "safu-grad-text-l" : "text-gray-400")}
							onClick={() => {
								setTab("Explore");
							}}
						>
						...
						{walletClient && (
							<h2
								className={heading_classes + (tab === "Launches" ? "safu-grad-text-l" : "text-gray-400")}
								onClick={() => {
									setTab("Launches");
								}}
							>
						...
						<h2
							className={heading_classes + (tab === "Stealth" ? "safu-grad-text-l" : "text-gray-400")}
							onClick={() => {
								setTab("Stealth");
							}}
						>
						...
						<h2
							className={heading_classes + (tab === "Presales" ? "safu-grad-text-l" : "text-gray-400")}
							onClick={() => {
								setTab("Presales");
							}}
						>
						...
						<h2 className="max-xl:hidden w-32 self-end ml-auto pt-2 pb-2.5 pl-3.5 rounded-2xl flex border border-neutral-700">
