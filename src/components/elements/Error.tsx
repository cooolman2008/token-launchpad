...
const Error = ({ error, des }: { error: string; des?: string }) => {
		...
		<>
			{isError && (
				<div className="fixed top-0 left-0 z-50 flex justify-center items-center h-screen w-screen bg-[rgba(0,0,0,0.75)]">
					<div className="relative flex flex-col w-3/4 xl:w-1/3 h-80 bg-neutral-900 rounded-xl items-center justify-center border border-pink-600/45 p-4">
